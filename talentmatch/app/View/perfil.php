...
<img class="place" id="perf" src="../../data/<?php echo $artista->getFotoPerfil(); ?>" alt="">
    ...
    <input type="text" name="nomeUsuario" class="input-field" value="<?php echo $artista->getNomeUsuario(); ?>" disabled><br>
        ...
        <div class="modal-body">
          <form action="../Controller/ProjetoController.php" method="POST" enctype="multipart/form-data">
            <div class="row">
              ...
              <input type="hidden" id = "detalhesId" name="id" value="2">
        ...
        <div class="modal-body">
          <form action="../Controller/ProjetoController.php" method="POST" enctype="multipart/form-data">
            <div class="row">
              ...
              <input type="hidden" id = "detalhesId" name="id" value="">
            </div>
            <div class="row">
              <div class="col-md-12 text-right">
                <br>
